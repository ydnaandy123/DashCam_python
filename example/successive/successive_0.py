...
needVisual, needGround, addPlane = True, False, True
# Novel view
offsetPos, offsetDeg = [0, 0, 0], 0
texture_height, texture_width = 256, 512
imageSynthesis, planeJoints, needTexture = False, False, False
"""
Variables
"""
...
"""
if needTexture:
    gpyViewWindow = glumpy_setting.GpyViewWindow(width=texture_width, height=texture_height)
