#!/usr/bin/python3
# ==============================================================
# viewpoint systhesis perspective virtual camera located in the center of the sphere
# ==============================================================
import numpy as np
import sys
import scipy.misc
        ...
        if needVisual:
            if needPerspective:
                ...
                perspective_data = np.zeros((pano_height*pano_width),
                                            dtype=[('a_position', np.float32, 3), ('a_color', np.float32, 3)])
                sphericalRay = google_parse.create_spherical_ray(pano_height, pano_width)
                perspective_data['a_position'] = sphericalRay.reshape((pano_height*pano_width, 3)) * -1000
